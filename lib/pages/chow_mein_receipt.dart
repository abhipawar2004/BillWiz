...
class ChowMeinReceipt extends StatelessWidget {
  @override
  ...
  double fem = MediaQuery.of(context).size.width / 430;
    ...
    Container(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(0.9*fem, 4.7*fem, 1.2*fem, 5.4*fem),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Container(
              margin: EdgeInsets.fromLTRB(0.7*fem, 0*fem, 0.7*fem, 2.3*fem),
              child: Align(
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0.2*fem, 0*fem, 0*fem, 1.2*fem),
              child: Align(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            margin: EdgeInsets.fromLTRB(0*fem, 0.4*fem, 0.1*fem, 0.3*fem),
                            child: Container(
                              decoration: BoxDecoration(
                                color: Color(0xFF128B42),
                              ),
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0.4*fem, 0*fem, 0.1*fem, 1.5*fem),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Container(
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0.7*fem, 0.8*fem),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0.4*fem, 0*fem, 0*fem, 0.5*fem),
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0.4*fem, 0*fem, 0.1*fem, 6.6*fem),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
            ...
            Container(
              margin: EdgeInsets.fromLTRB(1.7*fem, 0*fem, 1.4*fem, 0*fem),
              child: Container(
                decoration: BoxDecoration(
                  color: Color(0xFF128B42),
