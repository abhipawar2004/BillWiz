...
class ManchurianReceipt extends StatelessWidget {
  @override
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0.7*fem, 0*fem, 0.4*fem, 1.5*fem),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
              ...
              child: Stack(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Container(
                        margin: EdgeInsets.fromLTRB(0*fem, 0.9*fem, 4*fem, 11.2*fem),
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              margin: EdgeInsets.fromLTRB(0.6*fem, 0*fem, 0.3*fem, 0*fem),
                              child: Text(
                                '₹100',
                                style: GoogleFonts.getFont(
                                  'Jaldi',
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              margin: EdgeInsets.fromLTRB(0.6*fem, 0*fem, 0.4*fem, 0*fem),
                              child: Text(
                                '₹100',
                                style: GoogleFonts.getFont(
                                  'Jaldi',
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0.8*fem, 0*fem, 0*fem, 6.6*fem),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
